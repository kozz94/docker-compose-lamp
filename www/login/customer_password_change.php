<?php
    ...
    $error_messages = array("password_err" => "", "confirm_password_err" => "", "firstname_err" => "", "lastname_err" => "");

    $form_values = array("password" => "", "confirm_password" => "", "firstname" => "", "lastname" => "");
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        if(empty($error_messages["firstname_err"]) && $user_datas["firstname"] != $form_values["firstname"]){
            $error_messages["firstname_err"] = "A megadott keresztnév nem helyes!";
        }

        if(empty($error_messages["lastname_err"]) && $user_datas["lastname"] != $form_values["lastname"]){
            $error_messages["lastname_err"] = "A megadott vezetéknév nem helyes!";
        }

        if(empty($error_messages["password_err"]) && empty($error_messages["confirm_password_err"]) && empty($error_messages["firstname_err"]) && empty($error_messages["lastname_err"])){
...
<html>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-sm-4">
                <form method="post" action="customer_password_change.php">
                    ...
                    <div class="form-group <?php echo (!empty($error_messages["lastname_err"])) ? 'has-error' : ''; ?>">
                        ...
                        <input type="text" pattern="[a-zA-ZáéíÁÉÍóÓöÖőŐúÚűŰÜü]{3,}" class="form-control" name="lastname" placeholder="Add meg a vezetékneved!">
                    ...
                    <div class="form-group <?php echo (!empty($error_messages["firstname_err"])) ? 'has-error' : ''; ?>">
                        ...
                        <input type="text" pattern="[a-zA-ZáéíÁÉÍóÓöÖőŐúÚűŰÜü]{3,}" class="form-control" name="firstname" placeholder="Add meg a keresztneved!">
